...
class SP_WPS_Admin_Scripts {
	...
	public function admin_scripts() {
		if ( 'sp_wps_shortcodes' === get_current_screen()->id ) {
			...
			wp_enqueue_style( 'sp-wps-admin-meta-style', SP_WPS_URL . 'admin/assets/css/admin-meta.css', false, SP_WPS_VERSION );
			wp_enqueue_style( 'chosen-style', SP_WPS_URL . 'admin/assets/css/chosen.css', false, SP_WPS_VERSION );
		...
		wp_enqueue_style( 'sp-wps-admin-style', SP_WPS_URL . 'admin/assets/css/admin.css', false, SP_WPS_VERSION );
