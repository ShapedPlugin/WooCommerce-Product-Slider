...
class SP_Woo_Product_Slider_Functions {
	...
	public function help_page_callback() {
		...
		<div class="wrap about-wrap sp-wps-help">
			...
			<p class="about-text"><?php _e( 'Thank you for installing WooCommerce Product Slider! You\'re now running the most popular WooCommerce Product Slider plugin.', 'woo-product-slider' ); ?></p>
					...
					<div class="col">
						<div class="sp-wps-feature">
							...
							<p>Upsells are products that you recommend instead of the currently viewed product.
                                ...
                                They are typically complementary items. For example, if you are selling a laptop, cross-sells might be a protective case or stickers or a special adapter.
                            </p>
						</div>
					</div>
					<div class="col">
